...
enum { NetSupported, NetWMName, NetWMState, NetWMCheck,
       ...
       NetWMFullscreen, NetWMSticky, NetWMWindowsOpacity, NetActiveWindow, NetWMWindowType,
...
struct Client {
	...
	int bw, oldbw;
	unsigned int tags;
	int isfixed, isfloating, isurgent, neverfocus, oldstate, isfullscreen, issticky, cantfocus;
	int ignoresizehints;
	Client *next;
	Client *snext;
	Monitor *mon;
...
static void togglecanfocus(const Arg *arg);
...
xrdb(const Arg *arg)
{
	...
	drw_clr_create(drw, &scheme[SchemeNorm][ColBorder], normbordercolor, 1);
	drw_clr_create(drw, &scheme[SchemeNorm][ColBg], normbgcolor, 1);
	drw_clr_create(drw, &scheme[SchemeNorm][ColFg], normfgcolor, 1);
	drw_clr_create(drw, &scheme[SchemeSel][ColBorder], selbordercolor, 1);
	drw_clr_create(drw, &scheme[SchemeSel][ColBg], selbgcolor, 1);
	drw_clr_create(drw, &scheme[SchemeSel][ColFg], selfgcolor, 1);
